...
//========= Type Categories =================//
Route::get('/{type}/product', [App\Http\Controllers\Frontend\FrontendController::class, 'showTypeProduct']);
...
Route::put('/cart-product-update-checkout/{id}', [App\Http\Controllers\Frontend\CartController::class, 'updateCartProductCheckOut'])->name('cart.update');
