                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ url('/user/assign') }}" method="GET">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/user/assign') }}" class="input-group-text bg-danger text-white">Clear</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form action="{{ url('/user/assign')}}" method="get" class="user-form form-group mb-3">
                                        @csrf
                                ...
                                <div class="col-md-8">
                                    <form method="GET" action="{{ url('/user/assign') }}" class="form-inline mb-3">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/user/assign') }}" class="btn btn-sm btn-danger"><i class="fa fa-search"></i> Clear</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

                            <form action="{{ url('/assign-users/for-selected-orders') }}" method="post">
                                @csrf
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            {{-- <button type="submit" class="btn btn-danger">Filter</button> --}}
                                            <button type="submit" id="submit-btn" name="submit_button" value="print" class="btn btn-sm btn-info float-right mr-2" style="cursor: pointer">Assign User</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <table class="table table-striped table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-info" style="font-size: 12px; color: black">Nittomart</span><br/>
