                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ url('/all-orders') }}" method="GET">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/all-orders') }}" class="input-group-text bg-danger text-white">Clear</a>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form action="{{ url('/all-orders')}}" method="get" class="user-form form-group mb-3">
                                            @csrf
                                    ...
                                    <div class="col-md-8">
                                        <form method="GET" action="{{ url('/all-orders') }}" class="form-inline mb-3">
                                            @csrf
                                            <div class="input-group mb-3">
                                                ...
                                                <a href="{{ url('/all-orders') }}" class="btn btn-sm btn-danger"><i class="fa fa-search"></i> Clear</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
