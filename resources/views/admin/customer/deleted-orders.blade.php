                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ url('/all/order') }}" method="GET">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/all/order') }}" class="input-group-text bg-danger text-white">Clear</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <form method="GET" action="{{ url('/all/order') }}" class="form-inline mb-3">
                                        @csrf
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="{{ url('/all/order') }}" class="btn btn-sm btn-danger"><i class="fa fa-search"></i> Clear</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
